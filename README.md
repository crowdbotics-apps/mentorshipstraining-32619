...
## Project Structure
    ...
    ├── mentorshipstraining_32619  # Django project configurations
...
1. Clone this repo and `cd mentorshipstraining_32619`
...
2. Clone this repo and `cd mentorshipstraining_32619`
